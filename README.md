...
## BY OLUTOSIN FASHUSI
<b> EXCERPT FROM NBA GAMES PLAYED ON 2024-02-22 </b>
<br>
![2024-02-22MatchResults](https://github.com/user-attachments/assets/376ab6ea-146f-4ed8-b322-a9d84505ab42)
• DATE: Game date (Predictions begin on games played post-2024 All Star Game, played on 2024-02-18) <br>
...
• PROBABILITY ESTIMATE: For every match, team with the larger probability estimate is predicted to be the winner
...
•	Model identifies Opponent Points in the Paint in last game played (OPP PITPL1MA) as best feature for team, CLE (Cleveland Cavaliers) <br>
<br>
...
## MATCH DET @ IND, GAMEID: DECISION BOUNDARIES
